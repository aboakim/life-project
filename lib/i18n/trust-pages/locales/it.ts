  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "p",
          text: "Life Decision Engine è stato fondato e creato da Albert Akimyan (Ալբերտ Ակիմյան). Guida prodotto, framework editoriali e il motore di analisi delle decisioni su lifedecisions.space.",
        },
      ],
    },
    {
