  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "p",
          text: "Life Decision Engine a été fondé et créé par Albert Akimyan (Ալբերտ Ակիմյան). Il dirige le produit, les cadres éditoriaux et le moteur d’analyse des décisions sur lifedecisions.space.",
        },
      ],
    },
    {
