...
export default function AppRouteLoading() {
  return (
    <div className="route-loading-shell relative z-10 min-h-[50vh] pb-28 pt-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="animate-pulse space-y-4 rounded-[2rem] border border-[rgb(var(--page-accent,var(--accent))/0.14)] bg-[rgb(var(--page-accent,var(--accent))/0.04)] px-6 py-10 sm:px-10">
          <div className="h-3 w-24 rounded-full bg-[rgb(var(--page-accent,var(--accent))/0.18)]" />
