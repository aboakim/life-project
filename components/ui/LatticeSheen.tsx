...
export default function LatticeSheen() {
  return (
    ...
    >
      ...
      <div className="lattice-sheen-layer absolute -bottom-[8%] -start-[18%] size-[min(78vw,480px)] rounded-[45%] opacity-[0.11] [background:repeating-linear-gradient(-115deg,rgb(72_215_200/0.12)_0_1px,transparent_1px_13px)] [mask-image:radial-gradient(closest-side,rgb(0_0_0/0.85),transparent)]" />
    </div>
  );
}
